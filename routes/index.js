...
module.exports = function(router) {
    ...
    router.post('/createdepartment', isLoggedInSuperAdmin, function(req, res) {
		...
		labYokeGlobal.finddepartments(function(error, departments) {
			...
			res.render('departments', {labadmins: departments[4], section:"department", labs: departments[3], errormessagedept: errormessagedept, successmessagedept: successmessagedept, depts: departments[0], vennsettings: departments[2], users: departments[1],labyoker : req.session.user, loggedIn : true, isLoggedInAdmin: req.session.admin, title:'Departments'});
    ...
    router.post('/createlab', isLoggedInSuperAdmin, function(req, res) {
		...
		labYokeGlobal.finddepartments(function(error, departments) {
			...
			console.log("departments: " + departments.length);
			res.render('departments', {labadmins: departments[4], section:"lab", labs: departments[3], errormessagelab: errormessagelab, successmessagelab: successmessagelab, depts: departments[0], vennsettings: departments[2], users: departments[1], labyoker : req.session.user, loggedIn : true, isLoggedInAdmin: req.session.admin, title:'Departments'});
			req.session.messages = null;
		});
		});
    });
    ...
    router.post('/setvenn', isLoggedInSuperAdmin, function(req, res) {
		...
		labYokeGlobal.finddepartments(function(error, departments) {
			...
			console.log("departments: " + departments.length);
			res.render('departments', {labadmins: departments[4], section:"venn", labs: departments[3], vennsettings: departments[2], users: departments[1], errormessagevenn: errormessagevenn, successmessagevenn: successmessagevenn, depts: departments[0], labyoker : req.session.user, loggedIn : true, isLoggedInAdmin: req.session.admin, title:'Departments'});
			req.session.messages = null;
		});
		});
    });
    ...
    router.post('/setdisabled', isLoggedInSuperAdmin, function(req, res) {
		...
		labYokeGlobal.finddepartments(function(error, departments) {
			...
			console.log("departments: " + departments.length);
			res.render('departments', {labadmins: departments[4], section:"venn", labs: departments[3], vennsettings: departments[2], users: departments[1], errormessagedisable: errormessagedisable, successmessagedisable: successmessagedisable, depts: departments[0], labyoker : req.session.user, loggedIn : true, isLoggedInAdmin: req.session.admin, title:'Departments'});
			req.session.messages = null;
		});
		});
    });
